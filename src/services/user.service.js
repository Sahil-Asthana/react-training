...
const getAllUsers = (sortMethod,filterMethod,searchParam) => {
  return axios.get(API_URL+"/admin/users", {headers : authHeader(),params :{sort : sortMethod, filter : filterMethod, searchParam : searchParam }})
};
const getUser = () => {
...
const updateUser = (id,role) => {
  return axios.put(API_URL + "/admin/update-user/"+id, {role:role},{headers : authHeader()});
}
const deleteUser = (id) => {
  return axios.delete(API_URL+"/admin/delete-user/"+id,{headers : authHeader()});
}
const createUser = (name,email,password,password_confirmation,role) =>{
  return axios.post(API_URL+'/admin/create' ,{name,email,password,password_confirmation,role}, {headers : authHeader()});
}
...
const showAllTasks = (sortMethod,filterMethod,searchParam) => {
  return axios.get(API_URL+"/admin/all-tasks", {headers : authHeader(),params :{sort : sortMethod, filter : filterMethod, searchParam : searchParam }});
}
